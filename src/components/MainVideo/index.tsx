...
export const MainVideo = forwardRef<HTMLVideoElement, Props>(
  (
    {
      videoUrl,
      description,
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            {userData.email !== createdBy.email && (
              <Button
                variant="contained"
                sx={{
                  color: "#FFF",
          ...
          <Box sx={{ color: "#80819", fontSize: "12px" }}>
            <Box sx={{ display: "flex", alignItems: "flex-end" }}>
              ...
              <ThumbUpIcon
                sx={{
                  color: evaluation ? "blue" : "#80819",
                  cursor: "pointer",
                }}
                onClick={() =>
                  handleChangeEvaluation && handleChangeEvaluation(true)
                }
              />
            </Box>
            <Box sx={{ display: "flex", alignItems: "flex-end", mt: "5px" }}>
              ...
              <ThumbDownIcon
                sx={{
                  color: evaluation === false ? "blue" : "#80819",
                  cursor: "pointer",
                }}
                onClick={() =>
                  handleChangeEvaluation && handleChangeEvaluation(false)
                }
              />
            </Box>
          </Box>
